                ...
                text-left shadow-xl transition-all flex flex-col gap-5">
                  ...
                  <div className='flex-1 flex flex-col gap-3'>
                    ...
                    <div className='flex gap-3'>
                      ...
                      rounded-lg'>
                          <Image src={generateCarImageUrl(car, '29')} fill alt='car model'
                          priority className='object-contain' />
                      </div>
                      <div className='flex-1 relative w-full h-24 bg-primary-blue-100
                      rounded-lg'>
                          <Image src={generateCarImageUrl(car, '33')} fill alt='car model'
                          priority className='object-contain' />
                      </div>
                      <div className='flex-1 relative w-full h-24 bg-primary-blue-100
                      rounded-lg'>
                          <Image src={generateCarImageUrl(car, '13')} fill alt='car model'
                          priority className='object-contain' />
                      </div>
                    </div>
                  </div>
